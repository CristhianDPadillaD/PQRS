                ...
                <div class="card" style="border-radius: 1rem;">
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-5 d-none d-md-block">
                            <img src="https://i.pinimg.com/564x/91/85/54/91855436953116fcebd285e613d87f23.jpg"width="87%"
                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form id="loginForm" action="SvAcceder" method="post">
                                    ...
                                    <div class="d-flex align-items-center mb-3 pb-1">
                                        ...
                                        <span class="h1 fw-bold mb-0"> PQRS - Online</span>
                                    </div>

                                    <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Ingresar al sistema PQRS</h5>
